        ...
        <div className="lg:w-[60%] xl:w-[50%] w-[90%] mx-auto">
          ...
          <ul className="list-disc ml-5 mb-5">
            <li>
              ...
              Entwicklung einer Plattform für Bürgerdienste mit Suchfunktionen
              und interaktiven Formularen, die den Zugang zu Informationen
              erleichtern.
            </li>
            <li>
            ...
            <li>
              ...
              Mitarbeit an einer E-Commerce-Plattform zur Verwaltung von
              Produkten und Bestellungen, optimiert für Benutzer und Betreiber.
            </li>
            <li>und noch mehr...</li>
          </ul>
          ...
          <ul className="list-disc ml-5 mb-5">
            ...
            <li>
              ...
              produktiv, was sich in meiner Problemlösungsfähigkeit
              widerspiegelt.{' '}
            </li>
            <li>
          ...
          <ul className="list-disc ml-5 mb-5">
            ...
            <li>
              <strong>SEO-Praktiken: </strong>
              Einsatz von Suchmaschinenoptimierung (SEO), um die Sichtbarkeit
              der Websites zu erhöhen und das Ranking in Suchmaschinen zu
              verbessern.{' '}
            </li>
            <li>
