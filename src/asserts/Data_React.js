import r_auth from './imgs/React_Authentification.jpg';
import r_bestaet from './imgs/React_Bestaetigungsform.jpg';
import r_multi from './imgs/React_Multi-Sprache.jpg';
import r_slide from './imgs/React_Slide.jpg';
...
export const Data_React = [
  ...
  },
  {
    ...
    Description: 'React Authentification APP mit Firebase.',
  ...
  },
  {
    ...
    Description: 'Die Daten sind in der Konsole sichbar.',
